...
class FinalViewController: UIViewController, ARSCNViewDelegate {
    ...
    extension FinalViewController: MKMapViewDelegate {
...
extension FinalViewController: MessagePresenting {
...
extension FinalViewController:  Mapable {
...
extension FinalViewController: LocationServiceDelegate {
